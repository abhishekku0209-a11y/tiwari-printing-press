...
export class Backend implements backendInterface {
    ...
    async addTestimonial(arg0: AdminData, arg1: string, arg2: string, arg3: string, arg4: bigint): Promise<string> {
    ...
    async addVideo(arg0: AdminData, arg1: string, arg2: string, arg3: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async addVideoByUrl(arg0: AdminData, arg1: string, arg2: string, arg3: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.addVideoByUrl(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteTestimonial(arg0: AdminData, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async deleteVideo(arg0: AdminData, arg1: string): Promise<void> {
        if (this.processError) {
            try {
